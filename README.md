...
[![Build Status](https://travis-ci.org/reliese/laravel-model-gen.svg?branch=master)](https://travis-ci.org/reliese/laravel-model-gen)
[![Latest Stable Version](https://poser.pugx.org/reliese/laravel-model-gen/v/stable)](https://packagist.org/packages/reliese/laravel-model-gen)
[![Total Downloads](https://poser.pugx.org/reliese/laravel-model-gen/downloads)](https://packagist.org/packages/reliese/laravel-model-gen)
[![Latest Unstable Version](https://poser.pugx.org/reliese/laravel-model-gen/v/unstable)](https://packagist.org/packages/reliese/laravel-model-gen)
[![License](https://poser.pugx.org/reliese/laravel-model-gen/license)](https://packagist.org/packages/reliese/laravel-model-gen)
...
You will need to import the `reliese/laravel-model-gen` package via composer:
...
```shell
composer require reliese/laravel-model-gen --dev
```
...
fit your database needs. [Check it out](https://github.com/reliese/laravel-model-gen/blob/master/config/models.php) ;-)
